 ...
 */
@JsonPropertyOrder({
  MaterialDto.JSON_PROPERTY_ID,
  MaterialDto.JSON_PROPERTY_ITEMS,
  MaterialDto.JSON_PROPERTY_NAME
})
...
public class MaterialDto {
  ...
  private List<MaterialItemDto> items = new ArrayList<>();
  ...
  public MaterialDto id(String id) {
  ...
  **/
  ...
  public MaterialDto items(List<MaterialItemDto> items) {
    
    this.items = items;
    return this;
  }

  public MaterialDto addItemsItem(MaterialItemDto itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, material.id) &&
        Objects.equals(this.items, material.items) &&
