...
public class IEquipmentDeserializer extends StdDeserializer<IEquipment> {
    ...
    @Override
    public IEquipment deserialize(JsonParser parser, DeserializationContext ctxt) throws IOException {
        ...
        throw new InvalidClassException("Unknown IEquipment subclass");
    }
}