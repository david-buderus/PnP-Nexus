...
import de.pnp.manager.app.databinding.FragmentEquipmentBinding
 ...
 */
class EquipmentFragment(var character: PnPCharacter) : Fragment() {
    ...
    override fun onCreateView(
        ...
        return FragmentEquipmentBinding.inflate(inflater, container, false).also {
