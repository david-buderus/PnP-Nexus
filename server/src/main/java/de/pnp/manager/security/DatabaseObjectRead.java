...
/**
 * Method marked with this interface needs database object read rights.
 * <p>
 * Expects a path variable with the name 'id'.
 */
@Target({ElementType.METHOD, ElementType.TYPE})
@Retention(RetentionPolicy.RUNTIME)
@PreAuthorize(DatabaseObjectRead.AUTHORIZE_CONSTANT)
public @interface DatabaseObjectRead {

    /**
     * The SpEL definition of this annotation
     */
    // language=SpEL prefix="@PreAuthorize('" suffix="')"
    String AUTHORIZE_CONSTANT = UniverseOwner.AUTHORIZE_CONSTANT + " || (" + UniverseRead.AUTHORIZE_CONSTANT + "&& hasPermission(#id, \"" + DATABASE_OBJECT_TARGET_ID + "\", \"" + READ_ACCESS + "\"))";
}
