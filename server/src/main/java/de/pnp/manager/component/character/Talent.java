...
public class Talent extends DatabaseObject {
    ...
    public Talent(ObjectId id, String name, Set<Tag> tags, PrimaryAttribute firstAttribute,
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(getName(), talent.getName()) && Objects.equals(getTags(),
                talent.getTags()) && Objects.equals(getFirstAttribute(), talent.getFirstAttribute())
    ...
    @Override
    public int hashCode() {
        return Objects.hash(getName(), getTags(), getFirstAttribute(), getSecondAttribute(), getThirdAttribute());
    }
}
