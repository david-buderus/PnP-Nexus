...
public class ItemService extends RepositoryServiceBase<Item, ItemRepository> {
    ...
    public Collection<Weapon> getAllWeapons(@PathVariable String universe) {
    ...
    public Collection<Shield> getAllShields(@PathVariable String universe) {
    ...
    public Collection<Armor> getAllArmor(@PathVariable String universe) {
    ...
    public Collection<Jewellery> getAllJewellery(@PathVariable String universe) {
