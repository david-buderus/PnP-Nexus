...
public class MaterialRepositoryTest extends RepositoryTestBase<Material, MaterialRepository> {
    ...
    @Test
    void testItemLink() {
        Item itemWithSpellingMistake = itemRepository.insert(getUniverseId(),
    ...
    protected Material createObject() {
        Item ironIngot = itemRepository.insert(getUniverseId(),
    ...
    protected Material createSlightlyChangeObject() {
        Item ironNugget = itemRepository.insert(getUniverseId(),
