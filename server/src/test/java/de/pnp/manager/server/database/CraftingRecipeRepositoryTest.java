...
class CraftingRecipeRepositoryTest extends
    ...
    void testResultLink() {
        Item resultOld = itemRepository.insert(getUniverseName(),
                itemBuilder.createItemBuilder(getUniverseName()).withName("Result old").buildItem());
        Item resultNew = itemBuilder.createItemBuilder(getUniverseName()).withName("Result new").buildItem();
        Item materialItem = itemRepository.insert(getUniverseName(),
                itemBuilder.createItemBuilder(getUniverseName()).withName("A").buildItem());
    ...
    void testCraftingRecipeMaterial() {
        Item result = itemRepository.insert(getUniverseName(),
                itemBuilder.createItemBuilder(getUniverseName()).withName("Result").buildItem());
