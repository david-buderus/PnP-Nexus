...
class ItemStackTest {
    ...
    void testSubtractAmount() {
        ...
        assertThat(itemStackA.getAmount()).isEqualTo(0);

        ItemStack<Item> itemStackB = new ItemStack<>(10, TEST_ITEM);
        assertThat(itemStackB.subtractAmount(20)).isEqualTo(-10);
        assertThat(itemStackB.getAmount()).isEqualTo(0);
    }
    ...
    void testSetAmount() {
        ...
        assertThat(itemStackD.getAmount()).isEqualTo(5);

        ItemStack<Item> itemStackE = new ItemStack<>(10, TEST_ITEM);
        assertThat(itemStackE.setAmount(-5)).isEqualTo(-10);
        assertThat(itemStackE.getAmount()).isEqualTo(0);
    }

    @Test
    void testGetAmount() {
        assertThat(new ItemStack<>(10, TEST_ITEM).getAmount()).isEqualTo(10);
    }
