...
public class SpeedMemberState extends PowerMemberState implements IPowerMemberStateImpl, IAbsolutInitiativeMemberState {

    public SpeedMemberState(String name, int duration, boolean activeRounder, PnPCharacter source, float maxPower) {
